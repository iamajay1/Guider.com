...
var transporter = nodemailer.createTransport({
    ...
    var mailOptions = {
        from: 'Guider <support@Guider.com>',
        to: data.email,
        subject: 'Guider -Ticket Based Support System Notifications',
        text: 'Answer received for ticket number : ' + data.ticketNumber,
        html: '<h1>Hello ' + data.name + '</h1><br><h2>Sender from Guider.com </b> Someone Answered For your Question Which Has Ticket Number : ' + data.ticketNumber + '</h2>'
    }
...
eventEmitter.on('StatusChange', function (data) {
 ...
 var transporter = nodemailer.createTransport({
    ...
    var mailOptions = {
        ...
        to: data.email,
        subject: 'Guider -Ticket Based Support System Notifications',
        text: 'Status For Ticket Number ' + data.tno + " Changed To :" + data.status,
        html: "<h1>Hello "+ data.name + "</h1><br><h2> Status For Your Question Which Has Ticket Number "+ data.tno +" Changed To :"+data.status+"</h2>"
    }
